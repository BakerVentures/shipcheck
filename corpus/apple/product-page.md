---
shipcheck_source_id: product-page
...
You can now take advantage of [product page optimization](/app-store/product-page-optimization/), and create [custom product pages](/app-store/custom-product-pages/) on the App Store.
...
To ensure the icon is legible in all sizes, avoid adding unnecessary visual details. For information about creating a beautiful and memorable icon, see the [Human Interface Guidelines](/design/human-interface-guidelines/).
...
To learn about creating great app previews, see [Show More with App Previews](/app-store/app-previews/).
...
For screenshot specifications, see [App Store Connect Help](/help/app-store-connect/reference/screenshot-specifications/).
...
The [SKStoreReviewController API](/documentation/storekit/skstorereviewcontroller/) lets you give users an easy way to provide feedback about your app. You can prompt for ratings up to three times in a 365-day period. Users will submit a rating through the standardized prompt, and can write and submit a review without leaving the app.
...
For details, see [Ratings, Reviews, and Responses](/app-store/ratings-and-reviews/).
...
For details, see [Choosing a Category](/app-store/categories/).
...
For details, see [Localize App Store information](/help/app-store-connect/manage-app-information/localize-app-store-information/).

To learn about localizing your app, see[Expanding Your App to New Markets](/localization/).
...
[Learn more](/app-store/product-page-optimization/)
...
[Learn more](/app-store/custom-product-pages/)
